...
import ThreeDStreamContainer from '../3d-stream/container';
...
export default withLayoutConsumer(withModalMounter(withTracker(() => {
  ...
  const show3DScreen=Session.get('show3DScreen')

  if (MediaService.shouldShowWhiteboard() && !hidePresentation && !show3DScreen) {
    console.log('@sxr media container shouldShowWhiteboard',!hidePresentation,!show3DScreen)
  ...
  if (MediaService.shouldShowScreenshare() && (viewScreenshare || MediaService.isUserPresenter())) {
    //Session.set('show3DScreen',false);
    console.log('@sxr media container shouldShowScreenshare')
    data.children = <ScreenshareContainer />;
  }

  console.log('@sxr media container show3DScreen ',MediaService.shouldShow3DScreen(),show3DScreen)
  if(MediaService.shouldShow3DScreen() && show3DScreen){
    
    data.children=<ThreeDStreamContainer />
  }
